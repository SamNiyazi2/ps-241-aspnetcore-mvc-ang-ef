...
namespace ps_DutchTreat.Migrations
{
    ...
    [Migration("20220926010712_Redo-Complete-Migration")]
    partial class RedoCompleteMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("ps_241")
            ...
            modelBuilder.Entity("ps_DutchTreat.Data.Entities.CustomUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("ps_DutchTreat.Data.Entities.CustomUser", "user")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ps_DutchTreat.Data.Entities.CustomUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
